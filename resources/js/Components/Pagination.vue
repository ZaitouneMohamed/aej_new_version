...
<template>
    <nav
        class="flex flex-col items-center justify-center p-4 space-y-3 md:flex-row md:items-center md:space-y-0 md:justify-center"
    ...
    >
        ...
        <ul class="inline-flex items-center -space-x-px">
            <li>
                <Link
                    :href="items.prev_page_url ? items.prev_page_url : ''"
            ...
            <li v-for="link in items.links.slice(1, -1)" :key="link">
                <Link
                    :href="link.url"
                    :class="{
