...
const trucksList = dataFromProps.trucks;

const pageTitle = ref("Create new Paper");
</script>
        ...
        <div class="grid grid-cols-1 gap-9 sm:grid-cols-1">
            <div class="flex flex-col gap-9">
                ...
                <DefaultCard cardTitle="Create Form">
                    <form @submit.prevent="form.post('/admin/papers')">
                        {{ form }}
                        <div class="p-6.5">
                            <div class="mb-4.5 flex flex-col gap-6 xl:flex-row">
                                ...
                                <div class="w-full xl:w-1/2 mb-4.5">
                                    ...
                                    >
                                        <select v-model="form.camion_id" required
